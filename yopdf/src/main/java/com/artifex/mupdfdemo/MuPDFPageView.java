...
public class MuPDFPageView extends PageView implements MuPDFView {
	...
	public MuPDFPageView(Context c, FilePicker.FilePickerSupport filePickerSupport, MuPDFCore core, Point parentSize, Bitmap sharedHqBm) {
		...
		mTextEntryBuilder.setTitle("YoPDF: "
		...
		mChoiceEntryBuilder.setTitle("YoPDF: " + getContext().getString(R.string.choose_value));
	...
	public boolean copySelection() {
		...
		if (currentApiVersion >= Build.VERSION_CODES.HONEYCOMB) {
			...
			cm.setPrimaryClip(ClipData.newPlainText("YoPDF", text));
		} else {
